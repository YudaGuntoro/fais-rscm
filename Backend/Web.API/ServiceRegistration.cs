...
public static class ServiceRegistration
{
    public static void AddInfrastructure(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        {
            c.SwaggerDoc("v1", new OpenApiInfo { Title = "rscm-fais Monitoring API", Version = "v1" });
        ...
        var connectionString = ReadSettingsIniValue("Database", "ConnectionString")
            ...
            ?? "Server=127.0.0.1;Port=3306;User ID=root;Password=root_native;Database=rscm_fais;SslMode=None;AllowPublicKeyRetrieval=True;";
    ...
    public static void UseWebApiPipeline(this WebApplication app)
    {
        ...
        {
            app.UseSwagger();
            app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "rscm-fais Monitoring API v1"));
        }
